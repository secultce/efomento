...
class Notify
{
    ...
    public function send(string $message, string $type = 'default', ?string $title = null, ?array $meta = null): void
    {
    ...
    public function default(string $message, ?string $title = null, ?array $meta = null): void
    {
        $this->send($message, 'default', $title, $meta);
    }

    public function success(string $message, ?string $title = null, ?array $meta = null): void
    {
        $this->send($message, 'success', $title, $meta);
    }

    public function error(string $message, ?string $title = null, ?array $meta = null): void
    {
        $this->send($message, 'error', $title, $meta);
    }

    public function warning(string $message, ?string $title = null, ?array $meta = null): void
    {
        $this->send($message, 'warning', $title, $meta);
    }

    public function info(string $message, ?string $title = null, ?array $meta = null): void
    {
