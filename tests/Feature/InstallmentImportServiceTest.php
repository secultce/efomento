...
class InstallmentImportServiceTest extends TestCase
{
    ...
    public function test_it_updates_the_first_unpaid_installment_when_previous_one_is_paid(): void
    {
        ...
        $unpaid = Installment::factory()->create([
            'budget_id' => $budget->id,
        ...
        $file = $this->makeSpreadsheet([
            [
                'Data NL' => '10/01/2026',
                'Nota de Liquidação' => 'NL999',
                'Data OB' => '15/01/2026',
                'Ordem Bancária' => 'OB999',
                'Fonte Completa' => 'Fonte Teste',
                'Natureza Despesa' => '339030',
                'Processo' => '23000.000001/2024-10',
                'Credor' => '12345678900',
        ...
        $this->assertSame(1, $result['updated']);
        $this->assertSame(0, $result['skipped']);
        $this->assertSame(2, $result['installment']);

        $unpaid->refresh();

        $this->assertSame('NL999', $unpaid->settlement_number);
        $this->assertSame('OB999', $unpaid->payment_order_number);
        $this->assertSame('1750.00', $unpaid->payment_amount);
    }
