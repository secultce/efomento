...
<template>
    ...
    <v-dialog v-model="isOpen" max-width="560" persistent>
        <v-card class="rounded-lg">
            <v-card-title class="font-weight-bold pa-4 pb-2"> Lista de documentos </v-card-title>
            ...
            <v-card-text class="pa-4 pt-2">
                ...
                >
                    <span class="text-sm text-[#3b3b3c] font-medium">
                        ...
                        {{ doc.project.title_project == null ? doc.project.agent.name : doc.project.title_project }}
                    </span>
