                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <v-tabs-window v-model="tab">
                            <v-tabs-window-item value="open">
                                <div class="p-5">
                                    <div v-if="hasRole('fomento', 'coord_fomento')" class="p-5">
                            ...
                            <v-tabs-window-item value="ana_jur">
                                <div v-if="hasRole('juridico', 'coord_juridico')" class="p-5">
                            ...
                            <v-tabs-window-item value="for_pro">
                                <div class="p-5">
                                    @can('acompanhamento', 'coord_juridico') Conteúdo da aba FORMALIZAÇÃO DE PROCESSOS
                                    @endcan
                                </div>
                            </v-tabs-window-item>
                            <v-tabs-window-item value="or_per">
                                <div class="p-5">
                                    @can('orcamentario', 'coord_orcamentario') Conteúdo da aba ORÇAMENTO E PARCELA
                                    @endcan
                                </div>
                            </v-tabs-window-item>
                            <v-tabs-window-item value="pay">
                                <div class="p-5">Conteúdo da aba PAGAMENTO</div>
                            </v-tabs-window-item>
                        </v-tabs-window>
                    </div>
                </div>
