...
const save = () => {
    ...
    router.put(
        ...
        {
            onSuccess: () => {
                flash.value = 'Permissões salvas com sucesso!';
            },
            onError: () => {
                flash.value = 'Erro ao salvar. Tente novamente.';
            },
            onFinish: () => {
                saving.value = false;
            },
    ...
    <AuthenticatedLayout>
        <div class="py-4">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <!-- Flash -->
                <v-alert v-if="flash" type="success" variant="tonal" closable class="mb-4" @click:close="flash = ''">
                    {{ flash }}
                </v-alert>
                    ...
                    <v-row align="start" no-gutters>
                        ...
                        <v-col cols="9">
                            <v-row class="mb-2 p-2">
                                <v-col>
                                    <h3>Administração de funções</h3>
                                </v-col>
                                <v-col>
                                    <v-row>
                                        <v-col cols="6">
                                            ...
                                            <v-table density="compact" fixed-header>
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center text-xs font-weight-bold">Fazer tudo</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <template v-for="module in modules" :key="module.key">
                                                        ...
                                                        <!-- Uma linha por role -->
                                                        <tr v-for="role in roles" :key="`${module.key}-${role.name}`">
                                                            ...
                                                            >
                                                                <v-checkbox-btn
                                                                    ...
                                                                    v-model="
                                                                        matrix[role.name][`${module.key}.${action.key}`]
                                                                    "
                                                                    color="red"
                                                                    density="compact"
                                                                />
                                                            ...
                                                            <td class="text-center">
                                                                <v-checkbox-btn
                                                                    ...
                                                                    :indeterminate="
                                                                        isSomeChecked(role.name, module.key)
                                                                    "
                                                                    color="primary"
                                                                    density="compact"
                                                                    @update:model-value="
                                                                        toggleAll(role.name, module.key)
                                                                    "
                                                                />
                                                            </td>
                                                        </tr>
